...
#add "garmoncheg" using logging for debugging purposes
import logging
logging.basicConfig()
...
class FlickrSyncr:
    ...
    def _syncPhoto(self, photo_xml, refresh=False):
        ...
        #"garmoncheg" adding logging of photo sync for debugging purposes
        log.info('now Syncing photo with flickr id "'+photo_id+'"' )
